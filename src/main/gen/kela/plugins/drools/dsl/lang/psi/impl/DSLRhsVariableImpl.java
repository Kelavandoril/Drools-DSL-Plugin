...
public class DSLRhsVariableImpl extends ASTWrapperPsiElement implements DSLRhsVariable {

  public DSLRhsVariableImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DSLVisitor visitor) {
    visitor.visitRhsVariable(this);
  }
