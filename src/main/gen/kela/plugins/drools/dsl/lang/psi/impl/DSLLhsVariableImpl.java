...
public class DSLLhsVariableImpl extends ASTWrapperPsiElement implements DSLLhsVariable {

  public DSLLhsVariableImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DSLVisitor visitor) {
    visitor.visitLhsVariable(this);
  }
