...
public class DSLDebugCommentImpl extends ASTWrapperPsiElement implements DSLDebugComment {

  public DSLDebugCommentImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DSLVisitor visitor) {
    visitor.visitDebugComment(this);
  }
