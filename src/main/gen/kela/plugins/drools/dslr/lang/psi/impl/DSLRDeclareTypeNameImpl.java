...
public class DSLRDeclareTypeNameImpl extends ASTWrapperPsiElement implements DSLRDeclareTypeName {

  public DSLRDeclareTypeNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DSLRVisitor visitor) {
    visitor.visitDeclareTypeName(this);
  }
