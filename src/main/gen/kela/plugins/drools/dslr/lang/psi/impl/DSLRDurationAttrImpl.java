...
public class DSLRDurationAttrImpl extends ASTWrapperPsiElement implements DSLRDurationAttr {

  public DSLRDurationAttrImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DSLRVisitor visitor) {
    visitor.visitDurationAttr(this);
  }
