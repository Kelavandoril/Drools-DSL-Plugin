...
public class DSLRCalendarExprImpl extends ASTWrapperPsiElement implements DSLRCalendarExpr {

  public DSLRCalendarExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DSLRVisitor visitor) {
    visitor.visitCalendarExpr(this);
  }
