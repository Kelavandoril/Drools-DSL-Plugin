...
public class DSLREnabledAttrImpl extends ASTWrapperPsiElement implements DSLREnabledAttr {

  public DSLREnabledAttrImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DSLRVisitor visitor) {
    visitor.visitEnabledAttr(this);
  }
