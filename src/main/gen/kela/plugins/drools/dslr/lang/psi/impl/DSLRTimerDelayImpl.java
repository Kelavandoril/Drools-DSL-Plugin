...
public class DSLRTimerDelayImpl extends ASTWrapperPsiElement implements DSLRTimerDelay {

  public DSLRTimerDelayImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DSLRVisitor visitor) {
    visitor.visitTimerDelay(this);
  }
