...
public class DSLRDialectNameImpl extends ASTWrapperPsiElement implements DSLRDialectName {

  public DSLRDialectNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DSLRVisitor visitor) {
    visitor.visitDialectName(this);
  }
