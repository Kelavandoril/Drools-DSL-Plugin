...
public class DSLRAutoFocusAttrImpl extends ASTWrapperPsiElement implements DSLRAutoFocusAttr {

  public DSLRAutoFocusAttrImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DSLRVisitor visitor) {
    visitor.visitAutoFocusAttr(this);
  }
