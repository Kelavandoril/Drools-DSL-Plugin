...
public class DSLRNoLoopAttrImpl extends ASTWrapperPsiElement implements DSLRNoLoopAttr {

  public DSLRNoLoopAttrImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DSLRVisitor visitor) {
    visitor.visitNoLoopAttr(this);
  }
