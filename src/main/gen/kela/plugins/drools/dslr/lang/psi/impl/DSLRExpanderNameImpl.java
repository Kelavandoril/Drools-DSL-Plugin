...
public class DSLRExpanderNameImpl extends ASTWrapperPsiElement implements DSLRExpanderName {

  public DSLRExpanderNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DSLRVisitor visitor) {
    visitor.visitExpanderName(this);
  }
