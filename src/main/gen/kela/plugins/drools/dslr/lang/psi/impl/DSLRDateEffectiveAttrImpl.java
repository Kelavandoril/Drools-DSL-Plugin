...
public class DSLRDateEffectiveAttrImpl extends ASTWrapperPsiElement implements DSLRDateEffectiveAttr {

  public DSLRDateEffectiveAttrImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DSLRVisitor visitor) {
    visitor.visitDateEffectiveAttr(this);
  }
