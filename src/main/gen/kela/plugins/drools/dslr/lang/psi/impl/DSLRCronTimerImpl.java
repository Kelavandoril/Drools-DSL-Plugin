...
public class DSLRCronTimerImpl extends ASTWrapperPsiElement implements DSLRCronTimer {

  public DSLRCronTimerImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DSLRVisitor visitor) {
    visitor.visitCronTimer(this);
  }
