...
public class DSLRTimerIntervalImpl extends ASTWrapperPsiElement implements DSLRTimerInterval {

  public DSLRTimerIntervalImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DSLRVisitor visitor) {
    visitor.visitTimerInterval(this);
  }
