...
public class DSLRImportStatementImpl extends ASTWrapperPsiElement implements DSLRImportStatement {

  public DSLRImportStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public DSLRImportName getImportName() {
    return findNotNullChildByClass(DSLRImportName.class);
  }
