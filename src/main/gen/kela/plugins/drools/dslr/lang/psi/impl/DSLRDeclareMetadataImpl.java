...
public class DSLRDeclareMetadataImpl extends ASTWrapperPsiElement implements DSLRDeclareMetadata {

  public DSLRDeclareMetadataImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DSLRVisitor visitor) {
    visitor.visitDeclareMetadata(this);
  }
