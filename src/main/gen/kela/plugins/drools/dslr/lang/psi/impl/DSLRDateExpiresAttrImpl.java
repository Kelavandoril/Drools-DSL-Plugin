...
public class DSLRDateExpiresAttrImpl extends ASTWrapperPsiElement implements DSLRDateExpiresAttr {

  public DSLRDateExpiresAttrImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DSLRVisitor visitor) {
    visitor.visitDateExpiresAttr(this);
  }
