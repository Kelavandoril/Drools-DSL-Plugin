...
public class DSLRActivationGroupNameImpl extends ASTWrapperPsiElement implements DSLRActivationGroupName {

  public DSLRActivationGroupNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DSLRVisitor visitor) {
    visitor.visitActivationGroupName(this);
  }
