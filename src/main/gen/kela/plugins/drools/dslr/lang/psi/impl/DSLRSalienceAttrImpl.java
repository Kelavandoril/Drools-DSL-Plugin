...
public class DSLRSalienceAttrImpl extends ASTWrapperPsiElement implements DSLRSalienceAttr {

  public DSLRSalienceAttrImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DSLRVisitor visitor) {
    visitor.visitSalienceAttr(this);
  }
